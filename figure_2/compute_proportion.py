...
def compute_proportion(gamma,
    ...
    TRANSACT_clf = TRANSACT(kernel='rbf',
    ...
    sigma_offset_source = TRANSACT_clf.principal_vectors_.gamma_coef['source'].dot(source_gaussian_depth)
    sigma_offset_target = TRANSACT_clf.principal_vectors_.gamma_coef['target'].dot(target_gaussian_depth)
    ...
    sigma_linear_source = TRANSACT_clf.principal_vectors_.gamma_coef['source'].dot(source_basis_eval)
    sigma_linear_target = TRANSACT_clf.principal_vectors_.gamma_coef['target'].dot(target_basis_eval)
